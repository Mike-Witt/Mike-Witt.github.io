#
#   Tyler Dwyer's Block_Sphere.py
#
#   Downloaded from: www.tylerdwyer.com in May 2015
#
# Attemting to get it running ...
#
#   apt-get install python-visual
#
# ... but I still don't know where window() is supposed to come from

from __future__ import division, print_function
from visual import * # see the note above on python-visual. This is VPython.
